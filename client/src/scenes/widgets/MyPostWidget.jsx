    ...
    return (
        <WidgetWrapper>
            <FlexBetween gap="1.5rem">
                ...
                <InputBase placeholder={`What's on your mind, ${firstName}.`} onChange={(e) => setPost(e.target.value)} value={post} sx={{width: "100%", backgroudColor: palette.neutral.light, borderRadius: "2rem", padding: "1rem 2rem", }}/>
            </FlexBetween>
            {isImage && (
                <Box border={`1px solid ${medium}`} borderRadius="5px" mt="1rem" p="1rem">
                    <Dropzone acceptedFiles=".jpg, .jpeg, .png" multiple={false} onDrop={(acceptedFiles) => setImage("picture", acceptedFiles[0])}>
